...
1. **[PIPELINE_GUIDE.md](PIPELINE_GUIDE.md)** ⭐ **Run the pipeline**

   - Complete pipeline usage for Colab & Local
...
**Recommendation**: Always start with [SETUP_GUIDE.md](SETUP_GUIDE.md) for setup instructions.
